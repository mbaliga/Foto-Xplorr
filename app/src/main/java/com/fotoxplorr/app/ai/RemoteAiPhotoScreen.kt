...
fun RemoteAiPhotoScreen(
    ...
    val stillImages = remember(assets) { assets.filter { !it.isVideo && !it.isTrashed }.take(MAX_PICKER_ASSETS) }
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            Column(Modifier.weight(1f)) {
                ...
                Text("Nothing is transmitted until the final Send confirmation", style = MaterialTheme.typography.labelSmall)
            }
        }
        ...
        Row(
            ...
            Button(
                enabled = selectedProvider != null && selectedAsset != null && prompt.isNotBlank() && requestJob?.isActive != true,
                onClick = {
        ...
        AlertDialog(
            ...
            text = {
                Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                    ...
                    Text("Image: ${requestPreview.imageWidth} × ${requestPreview.imageHeight}, ${formatBytes(requestPreview.imageBytes)}, ${requestPreview.imageMimeType}")
            ...
            dismissButton = { TextButton(onClick = { preview = null; preparedImage = null }) { Text("Cancel") } },
        )
    }
}
